    ...
    <div class="container-fluid py-5">
      <div class="row d-flex">          
        <div class="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 order-sm-0 order-12" style="margin-right:-120px;">
          <img class="img-fluid" src="@/assets/spe.jpg">
        </div>
        <div class="col-12 col-xl-6 col-lg-5 col-md-6 col-sm-12 order-first order-xl-0">
          <h1>   Hey there !!  </h1>
          <h2 style="color:grey"> Got a special offer in ur min to ?!!</h2>
          <form>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <input type="text" class="form-control" required>
              <label class="label" for="address">Address to deliver</label>
            </div>
           <div class="form-group">
              <input type="text" class="form-control" required>
            ...
            <div class="form-group">
              <input type="text" class="form-control" required>
              <label class="label" for="name">The color u want</label>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" required>
             ...
             <div class="form-group">
              <textarea class="form-control" style="overflow:hidden; height:130px" rows="4" required></textarea>
              <label class="label" for="Message">Additional description to help us</label>
            </div>
