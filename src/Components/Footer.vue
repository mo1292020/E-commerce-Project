    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-12 col-xl-6 col-lg-3 col-md-3 col-sm-12 text-left text-md-right pb-5">
          <div class="footer-widget">
            <h4>E-commerce : We r selling products here</h4>
            <h4>And stuff like that</h4>
            <a href="mailto:#">mohamedmm99879@gmail.com</a>
            <h6>+20 1159218894</h6>
          </div>
        </div>
      ...
      <div class="row justify-content-between">
        <div class="col-xl-7 col-lg-6 col-md-6 col-sm-6 col-6">
          <div class="tiny-footer">
            <p>This Is our Vue project © All Rights Reserved 2021 </p>
          </div>
        </div>
